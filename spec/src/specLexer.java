...
public class specLexer extends Lexer {
    ...
    public final void mIntegerTypeSuffix() throws RecognitionException {
        try {
            // ./src/spec.g3:722:19: ( ( 'l' | 'L' | ( '.' Identifier ) ) )
            // ./src/spec.g3:722:21: ( 'l' | 'L' | ( '.' Identifier ) )
            {
            // ./src/spec.g3:722:21: ( 'l' | 'L' | ( '.' Identifier ) )
            int alt8=3;
            switch ( input.LA(1) ) {
            ...
            default:
                NoViableAltException nvae =
                    new NoViableAltException("722:21: ( 'l' | 'L' | ( '.' Identifier ) )", 8, 0, input);
            ...
            switch (alt8) {
                ...
                case 2 :
                    ...
                    break;
                case 3 :
                    // ./src/spec.g3:722:30: ( '.' Identifier )
                    {
                    // ./src/spec.g3:722:30: ( '.' Identifier )
                    // ./src/spec.g3:722:31: '.' Identifier
                    {
                    match('.'); 
                    mIdentifier(); 
    ...
    public final void mCharacterLiteral() throws RecognitionException {
        try {
            ...
            if ( (LA23_0=='\\') ) {
                ...
                NoViableAltException nvae =
                    new NoViableAltException("738:14: ( EscapeSequence | ~ ( '\\'' | '\\\\' ) )", 23, 0, input);
    ...
    public final void mEscapeSequence() throws RecognitionException {
        try {
            ...
            if ( (LA25_0=='\\') ) {
                ...
                default:
                    NoViableAltException nvae =
                        new NoViableAltException("745:1: fragment EscapeSequence : ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UnicodeEscape | OctalEscape );", 25, 1, input);
                ...
                NoViableAltException nvae =
                    new NoViableAltException("745:1: fragment EscapeSequence : ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UnicodeEscape | OctalEscape );", 25, 0, input);
        ...
        try {
            ...
            if ( (LA26_0=='\\') ) {
                ...
                if ( ((LA26_1>='0' && LA26_1<='3')) ) {
                    ...
                    NoViableAltException nvae =
                        new NoViableAltException("752:1: fragment OctalEscape : ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) );", 26, 1, input);
                ...
                NoViableAltException nvae =
                    new NoViableAltException("752:1: fragment OctalEscape : ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) );", 26, 0, input);
